...
function registerHandlers() {
  ...
  ipcMain.handle('haqly:structures:create', (_event, companyId: string, payload, userId: string) => services.structures.create(companyId, payload, userId))
  ...
  ipcMain.handle('haqly:payroll-runs:validate', (_event, runId: string, userId: string) => services.payrollRuns.validate(runId, userId))
  ...
  ipcMain.handle('haqly:payroll-runs:finalize', (_event, runId: string, userId: string) => services.payrollRuns.finalize(runId, userId))
  ipcMain.handle('haqly:payroll-runs:post', (_event, runId: string, userId: string) => services.payrollRuns.post(runId, userId))
