...
const api: HaqlyApi = {
  ...
  employees: {
    ...
    create: (companyId, payload, userId) => ipcRenderer.invoke('haqly:employees:create', companyId, payload, userId),
  ...
  structures: {
    ...
    create: (companyId, payload, userId) => ipcRenderer.invoke('haqly:structures:create', companyId, payload, userId),
